...
public class Bill {
    ...
    public Bill(Integer rechnungsnummer, Invoice invoice, Customer customer, List<Position> positionen) {
        this.billNumber = rechnungsnummer;
        this.invoice = invoice;
        this.customer = customer;
        this.Postions = positionen;
    }

    public static Bill getRechnung(Connection con, int invoiceid) {
        Bill rechnung = new Bill();
        rechnung.billNumber = invoiceid;
        rechnung.invoice = Invoice.getInvoice(con, invoiceid);
        rechnung.customer = Customer.getCustomer(con, rechnung.invoice.customerid);
        rechnung.Postions = Position.getPositionen(con, invoiceid);
        return rechnung;
    }
    ...
    public String toString() {
        ...
        rechnung.append("  Rechnungsnummer: ").append(billNumber).append(System.lineSeparator()).append(System.lineSeparator());
        ...
        rechnung.append(System.lineSeparator());
        Postions.stream().forEach(p -> rechnung.append(p).append(System.lineSeparator()));
